    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<Contexto>
                ...
                //(options => options.UseSqlServer("Server=servidordoeric.database.windows.net;Database=bdcontroledecontas;User Id=eric;Password=99278605eeE;"));


            var app = builder.Build();

            //string de conexao azure
            //Server=servidoreric.database.windows.net;Database=ControleDeContas;User Id=eric;Password=99278605eeE;
